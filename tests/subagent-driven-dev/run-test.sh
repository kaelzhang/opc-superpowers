...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/opc-superpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/opc-superpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using opc-superpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
