...
mkdir -p src test docs/opc-superpowers/plans

# Create a simple implementation plan
cat > docs/opc-superpowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/opc-superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from opc-superpowers directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/opc-superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"opc-superpowers:subagent-driven-development"' "$SESSION_FILE"; then
