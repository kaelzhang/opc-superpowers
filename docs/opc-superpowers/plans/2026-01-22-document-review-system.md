...
> **For agentic workers:** REQUIRED: Use opc-superpowers:subagent-driven-development (if subagents available) or opc-superpowers:executing-plans to implement this plan.
...
**Spec:** docs/opc-superpowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/opc-superpowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use opc-superpowers:subagent-driven-development (if subagents available) or opc-superpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
