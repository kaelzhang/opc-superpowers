...
| Field | Value |
|-------|-------|
| opc-superpowers version | |
| Harness (Claude Code, Cursor, etc.) | |
| Harness version | |
| Model | |
| OS + shell | |

## Is this a opc-superpowers issue or a platform issue?
<!-- opc-superpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without opc-superpowers installed.

     If the problem persists without opc-superpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without opc-superpowers installed
