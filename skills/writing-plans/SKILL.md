...
**Context:** This should be run on the current `main` or `master` workspace after workspace verification.

**Save plans to:** `docs/opc-superpowers/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `docs/opc-superpowers/plans/<filename>.md`. Two execution options:**
...
- **REQUIRED SUB-SKILL:** Use opc-superpowers:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use opc-superpowers:executing-plans
