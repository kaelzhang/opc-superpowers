...
digraph process {
    ...
    "Use opc-superpowers:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use opc-superpowers:finishing-a-development-branch";
}
```
...
[Read plan file once: docs/opc-superpowers/plans/feature-plan.md]
...
You: "User level (~/.config/opc-superpowers/hooks/)"
...
Final reviewer: All requirements met, ready to commit locally
...
- **opc-superpowers:executing-plans** - Use for parallel session instead of same-session execution
