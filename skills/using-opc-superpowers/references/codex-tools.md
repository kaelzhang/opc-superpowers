...
Claude Code skills reference named agent types like `opc-superpowers:code-reviewer`.
...
|-------------------|------------------|
| `Task tool (opc-superpowers:code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
